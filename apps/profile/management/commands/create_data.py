...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        data_to_add = [
            {'nama_departemen': 'Departemen Pengembangan Perangkat Lunak', 'short_name': 'DepPPL', 'kode_departemen': 'TEKPL'},
            {'nama_departemen': 'Departemen Infrastruktur TI ', 'short_name': 'DepInTI', 'kode_departemen': 'TEKIT'},
            {'nama_departemen': 'Departemen Keamanan Siber', 'short_name': 'DepKS', 'kode_departemen': 'TEKKS'},
            {'nama_departemen': 'Departemen Layanan Pelanggan', 'short_name': 'DepLP', 'kode_departemen': 'OPSLP'},
            {'nama_departemen': 'Departemen Penjualan dan Pemasaran', 'short_name': 'DepSP', 'kode_departemen': 'OPSSP'},
            {'nama_departemen': 'Departemen Operasional Lapangan', 'short_name': 'DepOL', 'kode_departemen': 'OPSOL'},
            {'nama_departemen': 'Departemen Akuntansi dan Keuangan', 'short_name': 'DepAK', 'kode_departemen': 'FINAK'},
            {'nama_departemen': 'Departemen Perencanaan dan Anggaran', 'short_name': 'DepPA', 'kode_departemen': 'FINPA'},
            {'nama_departemen': 'Departemen Pajak dan Regulasi', 'short_name': 'DepPR', 'kode_departemen': 'FINPR'},
            {'nama_departemen': 'Departemen Rekrutmen dan Penempatan', 'short_name': 'DepRek', 'kode_departemen': 'SDMR'}
            ]
        ...
        if serializer.is_valid():
            ...
            self.stdout.write(self.style.SUCCESS('Data Departemen berhasil ditambahkan secara massal.'))
        else:
        ...
        data_to_add = [
            {'nama_divisi': 'Divisi Teknologi dan Informasi', 'short_name': 'DivTek', 'kode_divisi': 'TEK', 'departemen': 1},
            {'nama_divisi': 'Divisi Operasional', 'short_name': 'DivOps', 'kode_divisi': 'OPS', 'departemen':2 },
            {'nama_divisi': 'Divisi Keuangan ', 'short_name': 'DivKeu', 'kode_divisi': 'FIN', 'departemen':3 },
            {'nama_divisi': 'Divisi Sumber Daya Manusia', 'short_name': 'DivSDM', 'kode_divisi': 'SDM', 'departemen':4 },
            {'nama_divisi': 'Divisi Hukum dan Kepatuhan', 'short_name': 'DivHK', 'kode_divisi': 'HK', 'departemen':5 },
        ]
        ...
        for data in data_to_add:
            ...
            divisi_obj = Divisi.objects.get(id=divisi)
            jabatan_obj = Jabatan.objects.get(id=jabatan)

            profile = Profile.objects.create(user=user_obj, nama_lengkap=nama_lengkap, alamat=alamat, kota=kota, phone_number=phone_number, nik_group=nik_group, nik_lokal=nik_lokal, organisasi=organisasi, is_first_login=is_first_login, divisi=divisi_obj, jabatan=jabatan_obj)
